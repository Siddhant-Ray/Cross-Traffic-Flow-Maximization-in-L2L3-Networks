...
sudo ip netns exec router tc filter add dev router-eth3 parent 1: protocol ip prio 1 u32 match ip protocol 3 0xff match ip dsfield 128 0xff flowid 1:10
