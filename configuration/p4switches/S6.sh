...
tc class add dev port_S1 parent 1: classid 1:1 htb rate 6Mbit ceil 6Mbit burst 15k cburst 15k
    ...
    # gold
    tc filter add dev port_S1 parent 1: protocol all prio 1 u32 match ip protocol 17 0xff match ip tos 128 0xff flowid 1:11
    
    # silver
    tc filter add dev port_S1 parent 1: protocol all prio 1 u32 match ip protocol 17 0xff match ip tos 64 0xff flowid 1:12
    
    # bronze
    tc filter add dev port_S1 parent 1: protocol all prio 1 u32 match ip protocol 17 0xff match ip tos 32 0xff flowid 1:13
